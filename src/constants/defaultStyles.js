...
export const defaultSearchStyle = defaultStyle + "border-gray-100 h-12 flex-1 text-sm";
export const defaultInputInvalidStyle = defaultStyle + "border-red-400 h-12 flex-1";
...
export const defaultTdContent = "sm:w-full w-1/2 flex flex-wrap flex-row items-center";
